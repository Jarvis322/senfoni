          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Müzik tutkunları için en kaliteli enstrümanlar ve ekipmanlar. Profesyonel müzisyenlerden yeni başlayanlara kadar herkes için çözümler sunuyoruz.
              </p>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/urunler" className="text-gray-400 hover:text-white transition-colors flex items-center">
                    <FaChevronRight className="mr-2 text-xs" /> Ürünler
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/hakkimizda" className="text-gray-400 hover:text-white transition-colors flex items-center">
                    <FaChevronRight className="mr-2 text-xs" /> Hakkımızda
                  </Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-xl font-bold mb-6">Bülten</h3>
              <p className="text-gray-400 mb-4">
                Yeni ürünler, indirimler ve etkinliklerden haberdar olmak için bültenimize abone olun.
              </p>

                        ...
                        <div className="relative w-10 h-10 mr-3">
                          <Image 
                            ...
                            onError={(e) => {
                              ...
                              target.src = 'https://placehold.co/100?text=Ürün';
                            }}
                          />
                        </div>
                      )}
...
export default function FeaturedEditClient({ 
  initialData, 
  allProducts 
}: { 
  ...
  // Check if we have initialData from URL params (this takes precedence)
  const initialDataParam = searchParams.get('initialData');
  const effectiveInitialData = initialDataParam 
    ? JSON.parse(initialDataParam) 
    : initialData;
  
  // Check if we have products from URL params
  const productsParam = searchParams.get('products');
  const effectiveProducts = productsParam 
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          <div className="p-6">
            <FeaturedProductsForm initialData={effectiveInitialData} allProducts={effectiveProducts} />
          </div>
        </div>
      </main>
